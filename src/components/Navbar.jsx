    ...
    <>
      <style>{`
        ...
        @media (max-width: 860px) {
          ...
          .nb-logo { width: 100px; height: 100px; }
          .nb-brand-name { font-size: 15px; }
          .nb-brand-sub { font-size: 6.5px; letter-spacing: .16em; }
        ...
        @media (max-width: 480px) {
          .nb-logo { width: 100px; height: 100px; }
          .nb-brand-name { font-size: 13px; }
          .nb-brand-sub { font-size: 6px; letter-spacing: .12em; }
          .nb-brand-copy { margin-left: -20px; }
        }
      `}</style>
